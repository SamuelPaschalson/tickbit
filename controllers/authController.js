...
exports.signup = async (req, res) => {
  ...
  try {
    ...
    console.error("Error occurred while creating a new user", error.message);
...
exports.login = async (req, res) => {
  ...
  try {
    ...
    console.error("Error occurred while logging in the user", error.message);
...
exports.userData = async (req, res) => {
  ...
  try {
    ...
    console.error("Error occurred while getting user details", error.message);
    res.status(500).json({ success: false, error: error.message });
  }
};
